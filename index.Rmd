...
[bit.ly/3Dgenomics](https:/bit.ly/3Dgenomics)
...
<div class="my-footer">
<a href="https://dozmorovlab.github.io/"> `r icon::fontawesome("id-card", style = "solid")` dozmorovlab.github.io</a> | 
<a href="https://github.com/mdozmorov"> `r icon::fontawesome$brands$github` mdozmorov</a> | 
<a href="https://twitter.com/mikhaildozmorov"> `r icon::fontawesome$brands$twitter` @mikhaildozmorov</a>
</div>
...
- ~4 meters (~12ft) of the diploid genome is packed into the ~10um nucleus
...
- Disruption of the 3D genomic structure can lead to rewiring of enhancer-promoter interactions and changes in gene expression -> disease
...
.pull-left[ 
- Mouse reads have minimal effect on Hi-C data - direct alignment to the human genome works well  
...
.small[Dozmorov, Mikhail G, Katarzyna M Tyc, Nathan C Sheﬃeld, David C Boyd, Amy L Olex, Jason Reed, and J Chuck Harrell. “[Chromatin Conformation Capture (Hi-C) Sequencing of Patient-Derived Xenografts: Analysis Guidelines](https://www.biorxiv.org/content/10.1101/2020.10.17.343814v2)” _bioRxiv_ October 19, 2020]
...
.center[<img src="img/funding.png" height = 30>]
]
